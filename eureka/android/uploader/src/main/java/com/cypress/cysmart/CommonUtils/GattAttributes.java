...
public class GattAttributes {
    ...
    public static final java.util.HashMap<java.util.UUID, Integer> attributesImageMap = new java.util.HashMap<>();
    public static final java.util.HashMap<java.util.UUID, Integer> attributesCapSenseImageMap = new java.util.HashMap<>();
    public static final java.util.HashMap<java.util.UUID, String> attributesCapSense = new java.util.HashMap<>();
    private static java.util.HashMap<String, String> descriptorAttributes = new java.util.HashMap<>();
    private static java.util.HashMap<java.util.UUID, String> attributesUUID = new java.util.HashMap<>();
    private static java.util.HashMap<Integer, String> rdkAttributesUUID = new java.util.HashMap<>();
    /**
     * Services
     */
...
//                R.drawable.otafu);
    ...
    public static String lookupUUID(java.util.UUID uuid, String defaultName) {
...
//    public static int lookupImage(java.util.UUID uuid) {
//        int imageId = attributesImageMap.get(uuid) != null ? attributesImageMap
//                .get(uuid) : R.drawable.unknown;
//        return imageId;
//    }
//
//    public static String lookupNameCapSense(java.util.UUID uuid, String defaultName) {
//        String name = attributesCapSense.get(uuid);
//        return name == null ? defaultName : name;
//    }
//
//    public static int lookupImageCapSense(java.util.UUID uuid) {
