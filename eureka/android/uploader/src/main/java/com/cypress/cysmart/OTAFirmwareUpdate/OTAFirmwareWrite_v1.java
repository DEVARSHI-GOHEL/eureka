...
public class OTAFirmwareWrite_v1 {
    ...
    public OTAFirmwareWrite_v1(BluetoothGattCharacteristic otaCharacteristic, BleService bleService) {
    ...
    public void OTAEnterBootLoaderCmd(byte checkSumType, byte[] productId) {
        ...
        mBleService.writeOTABootLoaderCommand(mOtaCharacteristic, commandBytes);
    }
    ...
    public void OTAExitBootloaderCmd(byte checkSumType) {
        ...
        mBleService.writeOTABootLoaderCommand(mOtaCharacteristic, commandBytes, true);
    }
}
