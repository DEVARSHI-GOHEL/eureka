...
public class StepGoalResponse extends ResponseBase {
    private String _userId = "";
    private String _authId = "";

    public StepGoalResponse(ResultCodeEnum pErrorCode) {
        super(pErrorCode);
    }

    public StepGoalResponse(ResultCodeEnum pErrorCode, String pMessage) {
