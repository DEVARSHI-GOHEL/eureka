...
public class StepCountResponse extends ResponseBase {
    private String _userId = "";
    private String _authId = "";

    public StepCountResponse(ResultCodeEnum pErrorCode) {
        super(pErrorCode);
    }

    public StepCountResponse(ResultCodeEnum pErrorCode, String pMessage) {
...
*/
    ...
    public StepCountResponse(String pSimuId, String pSimuMessage) {
