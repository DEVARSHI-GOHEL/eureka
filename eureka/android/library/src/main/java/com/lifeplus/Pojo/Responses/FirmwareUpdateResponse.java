...
public class FirmwareUpdateResponse extends ResponseBase {
    private String _userId = "";
    private String _authId = "";

    public FirmwareUpdateResponse(ResultCodeEnum pErrorCode) {
        super(pErrorCode);
    }

    public FirmwareUpdateResponse(ResultCodeEnum pErrorCode, String pMessage) {
