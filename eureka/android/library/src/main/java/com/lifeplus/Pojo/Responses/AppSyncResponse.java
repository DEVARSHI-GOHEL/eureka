...
public class AppSyncResponse extends ResponseBase {
    private String _userId = "";
    private String _authId = "";

    public AppSyncResponse(ResultCodeEnum pErrorCode) {
        super(pErrorCode);
    }

    public AppSyncResponse(ResultCodeEnum pErrorCode, String pMessage) {
...
*/
    ...
    public AppSyncResponse(String pSimuId, String pSimuMessage) {
