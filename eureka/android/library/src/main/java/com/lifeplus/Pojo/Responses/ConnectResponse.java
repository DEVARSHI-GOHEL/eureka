...
public class ConnectResponse extends ResponseBase {
    private String _userId = "";
    private String _authId = "";

    public ConnectResponse(ResultCodeEnum pErrorCode) {
        super(pErrorCode);
    }

    public ConnectResponse(ResultCodeEnum pErrorCode, String pMessage) {
