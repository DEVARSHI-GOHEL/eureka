...
public class MealDataResponse extends ResponseBase {
    private String _userId = "";
    private String _authId = "";

    public MealDataResponse(ResultCodeEnum pErrorCode) {
        super(pErrorCode);
    }

    public MealDataResponse(ResultCodeEnum pErrorCode, String pMessage) {
...
*/
    ...
    public MealDataResponse(String pSimuId, String pSimuMessage) {
